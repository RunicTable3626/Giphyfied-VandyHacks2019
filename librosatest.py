...
filename = os.getcwd() + "\My Heart Will Go On (Love Theme from Titanic).wav"
print(filename)
sr = 16000
n_fft = 4096
len_hop = n_fft / 4
...
music_wav = np.asfortranarray(music_wav)
vocal_wav = np.asfortranarray(vocal_wav)
mix_wav = np.asfortranarray(mix_wav)
...
D_music = librosa.stft(music_wav, n_fft=int(n_fft), hop_length=int(len_hop))
D_vocal = librosa.stft(vocal_wav, n_fft=int(n_fft), hop_length=int(len_hop))
D_mix = librosa.stft(mix_wav, n_fft=int(n_fft), hop_length=int(len_hop))
...
music_wav_recon = librosa.istft(D_music, hop_length=int(len_hop))
vocal_wav_recon = librosa.istft(D_vocal, hop_length=int(len_hop))
mix_wav_recon = librosa.istft(D_mix, hop_length=int(len_hop))
